...
pkl_path = os.path.join(os.path.dirname(__file__), "predict_62.pkl")
...
print("="*80)
print("\nDeploy (from notebooks/): TOPIC_ID=62 PREDICT_PKL=testnet/topic_62_sol_24h_logreturn/predict_62.pkl python deploy_worker.py")
