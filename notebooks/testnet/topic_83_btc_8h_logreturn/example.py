...
pkl_path = os.path.join(os.path.dirname(__file__), "predict_83.pkl")
...
print("="*80)
print("\nDeploy (from notebooks/): TOPIC_ID=83 PREDICT_PKL=testnet/topic_83_btc_8h_logreturn/predict_83.pkl python deploy_worker.py")
