...
pkl_path = os.path.join(os.path.dirname(__file__), "predict_63.pkl")
...
print("="*80)
print("\nDeploy (from notebooks/): TOPIC_ID=63 PREDICT_PKL=testnet/topic_63_eth_24h_logreturn/predict_63.pkl python deploy_worker.py")
